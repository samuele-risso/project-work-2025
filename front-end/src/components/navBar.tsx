...
export default function NavBar() {
    return (
        <div className="card w-72 bg-white p-5 shadow-md shadow-purple-200/50 h-full">
            <ul className="w-full flex flex-col gap-2 mt-6">
                <li 
                    className="flex-center cursor-pointer p-16-semibold w-full whitespace-nowrap mb-2"
                >
                    <h1 className="text-5xl text-black">Samuele</h1>
                </li>
                <li
